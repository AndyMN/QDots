...
myPlotter.plotEigenvectors(SmallPotWellSolverGaAsX, 2)
myPlotter.savePlots("GaAsXWavek2.png")
myPlotter.plotEigenvectors(SmallPotWellSolverGaAsZ, 0)
myPlotter.savePlots("GaAsZWavek0.png")
myPlotter.plotEigenvectors(SmallPotWellSolverGaAsZ, 2)
myPlotter.savePlots("GaAsZWavek2.png")
...
myPlotter.plotEigenvalues(BigPotWellSolverSiZ, kVec, 4)
myPlotter.plotEigenvalues(SmallPotWellSolverSiZ,  kVec, 4)
...
myPlotter.plotEigenvectors(SmallPotWellSolverSiX, 0)
myPlotter.savePlots("SiXWavek0.png")
myPlotter.plotEigenvectors(SmallPotWellSolverSiX, 2)
myPlotter.savePlots("SiXWavek2.png")
myPlotter.plotEigenvectors(SmallPotWellSolverSiZ, 0)
myPlotter.savePlots("SiZWavek0.png")
myPlotter.plotEigenvectors(SmallPotWellSolverSiZ, 2)
myPlotter.savePlots("SiZWavek2.png")
